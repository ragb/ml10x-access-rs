...
use ml10x_core::device::segment_id;
use ml10x_core::encode::{encode_advanced_preset, encode_preset};
use ml10x_core::presets::{Connection, ConnectorSlug, Preset, PresetBody};
use ml10x_core::sysex::{iter_segments, parse_header};
    ...
    set_connections(
        ...
        vec![
            Connection {
                ...
                to_connector: ConnectorSlug::ARing,
            },
            Connection {
                from_connector: ConnectorSlug::ARing,
